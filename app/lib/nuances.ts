...
export const NUANCE_FAMILIES: NuanceFamily[] = [
  ...
  { label: "Gauche (PS, radicaux de gauche)", color: "#FF8AA6", codes: ["SOC", "LSOC", "BC-SOC", "RDG", "BC-RDG"] },
  { label: "Divers gauche", color: "#D98CAB", codes: ["DVG", "LDVG", "BC-DVG"] },
  ...
  { label: "Divers droite", color: "#7FA8D9", codes: ["DVD", "LDVD", "DVC", "LDVC", "BC-DVD", "BC-DVC"] },
